...
public class EntityEnderp extends EntityMob implements IBossDisplayData
{
	private static final String BOSS_NAME = StatCollector.translateToLocal("boss.EntityEnderp.name");
	...
	// EntityEnderman
	public EntityEnderp(World world)
	{
		super(world);
	...
	{
		return new ChatComponentText(BOSS_NAME);
	}
	...
	public void setScreaming(boolean b0)
	{
		this.dataWatcher.updateObject(18, (byte)(b0 ? 1 : 0));
	}
    ...
    protected boolean teleportRandomly()
    {
        ...
        double d1 = this.posY + (double)(this.rand.nextInt(64) - 48);
